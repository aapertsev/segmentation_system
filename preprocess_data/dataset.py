...
from .preprocess import preprocess, compute_dataset_mean_std  # импорт функции предобработки
...
class CTScanDataset(Dataset):
    def __init__(self, images_dir, masks_dir, transform=None, sigma=1):
        ...
        self.sigma = sigma
        self.mean, self.std = compute_dataset_mean_std(self.images_dir)
    ...
    def __getitem__(self, idx):
        ...
        processed_image = preprocess(image, self.mean, self.std, sigma=self.sigma)
